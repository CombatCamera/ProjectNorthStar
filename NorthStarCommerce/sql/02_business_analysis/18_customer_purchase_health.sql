...
File:
18_customer_purchase_health.sql

Purpose:
Evaluates the purchasing health of each customer by
comparing current purchasing behavior against each
...
Business Context:
Unlike previous reports that describe historical
customer activity, this query introduces a personalized
Customer Purchase Health model.
